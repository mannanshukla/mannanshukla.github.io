...
%-------------------------------------------
	...
	\resumeItem{Creating host functionality using \textbf{edge-tts with RVC, whisper, and llama3} to interact with users with all compute running locally}
...
\section{Leadership}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Relaunched club following 12 year gap, developed constitution, recruited \textbf{20 members}, and launched website}
